...
```js
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@f1611c2/scripts/image-classification-mobilenet/build/datasource.js?url=http://ai-sample.oss-cn-hangzhou.aliyuncs.com/image_classification/datasets/mnist.zip"
}
```
...
```js
{
  "dataflow": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@f1611c2/scripts/image-classification-mobilenet/build/dataflow.js?size=224&size=224"
}
```
