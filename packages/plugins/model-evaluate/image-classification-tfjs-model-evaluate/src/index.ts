import {ImageDataset, ModelEvaluateType, TfJsLayersModel, ArgsType, ImageDataLoader, EvaluateResult} from '@pipcook/pipcook-core';
...
const ModelEvalute: ModelEvaluateType = 
  async (data: ImageDataset, model: TfJsLayersModel, args: ArgsType): Promise<EvaluateResult> => {
