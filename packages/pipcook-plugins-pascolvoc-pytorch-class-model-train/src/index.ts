import {ModelTrainType, parseAnnotation, PascolVocSampleData, ModelTrainArgsType, PytorchModel} from '@pipcook/pipcook-core';
...
const pytorchPascolVocModelTrain: ModelTrainType = 
  async (data: PascolVocSampleData, model: PytorchModel, args: ModelTrainArgsType): Promise<PytorchModel> => {
  const {
    epochs = 10,
    batchSize = 16,
    saveModel
