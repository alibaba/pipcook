...
import {createAnnotationFile, createAnnotationFromJson, transformCsv} from './publicUtils';

export async function processImageClassification(data: any[],
  dataAccess: PipcookComponentResult,
