import {tfJsLayersModel, ArgsType, ModelEvaluateType, EvaluateResult, PascolVocSampleData, parseAnnotation} from '@pipcook/pipcook-core';
 ...
 */
const ModelEvalute: ModelEvaluateType = async (data: PascolVocSampleData, model: tfJsLayersModel, args: ArgsType): Promise<EvaluateResult> => {
