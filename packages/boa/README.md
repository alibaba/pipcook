<center>
  <img src="logo.png" alt="Boa: Using Python functions seamlessly in Node.js"/>
</center>

Using [Python][] functions seamlessly in Node.js, it delivers any [Python][] module for Node.js developer
in lower-cost to learn or use.

[![Build Status](https://github.com/yorkie/boa/workflows/ci/badge.svg?branch=master&event=push)](https://github.com/yorkie/boa/actions)
[![codecov](https://codecov.io/gh/yorkie/boa/branch/master/graph/badge.svg?token=jFlDx5Kux1)](https://codecov.io/gh/yorkie/boa)
