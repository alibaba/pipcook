import {ModelLoadType, PascolVocSampleData, getModelDir, tfJsLayersModel, ModelLoadArgsType} from '@pipcook/pipcook-core';
 ...
 */
const simpleCnnModelLoad: ModelLoadType = async (data: PascolVocSampleData, args: ModelLoadArgsType): Promise<tfJsLayersModel> => {
  const {
