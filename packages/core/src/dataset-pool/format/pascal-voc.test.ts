...
const sample1: Sample = {
  data: {
    annotation: {
      ...pascalVocAnnotation[0].annotation, object: [
        { ...(pascalVocAnnotation[1].annotation.object as Array<any>)[0], name: 'dog' }, { ...(pascalVocAnnotation[1].annotation.object as Array<any>)[1], name: 'person' }
      ]
    }
  },
  label: [
...
const sample2: Sample = {
  data: {
    annotation: {
      ...pascalVocAnnotation[1].annotation, object: [
        { ...(pascalVocAnnotation[1].annotation.object as Array<any>)[0], name: 'dog' }, { ...(pascalVocAnnotation[1].annotation.object as Array<any>)[1], name: 'person' }
      ]
    }
  },
  label: [ { ...(pascalVocAnnotation[1].annotation.object as Array<any>)[0], name: 'dog' }, { ...(pascalVocAnnotation[1].annotation.object as Array<any>)[1], name: 'person' } ]
};

const sample3: Sample = {
  data: {
    annotation: {
      ...pascalVocAnnotation[2].annotation, object: [
        { ...(pascalVocAnnotation[2].annotation.object as Array<any>)[0], name: 'dog2' }, { ...(pascalVocAnnotation[2].annotation.object as Array<any>)[1], name: 'person2' }
      ]
    }
  },
  label: [ { ...(pascalVocAnnotation[2].annotation.object as Array<any>)[0], name: 'dog2' }, { ...(pascalVocAnnotation[2].annotation.object as Array<any>)[1], name: 'person2' } ]
};
