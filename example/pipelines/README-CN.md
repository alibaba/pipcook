...
```json
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/text-classification-bayes/build/datasource.js?url=file:///path/to/dataset-directory"
}
```
...
```json
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/text-classification-bayes/build/datasource.js?url=http:///oss-host/my-dataset.zip"
}
```
...
```json
{
  "model": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/text-classification-bayes/build/model.js?mode=en"
}
```
...
```json
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/image-classification/build/datasource.js?url=file:///path/to/dataset-directory"
}
```
...
```json
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/image-classification/build/datasource.js?url=http://oss-host/dataset.zip"
}
```
...
{
  "dataflow": [
    "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/image-classification/build/dataflow.js?size=224&size=224"
  ]
}
```
...
```json
{
  "model": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/image-classification/build/model.js?modelUrl=resnet",
}
```
...
```json
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/object-detection-yolo/build/datasource.js?format=pascalvoc&url=https://host/dataset.zip"
}
```
...
```json
{
  "datasource": "https://cdn.jsdelivr.net/gh/imgcook/pipcook-script@b84d8f6/scripts/object-detection-yolo/build/datasource.js?format=pascalvoc&url=file:///path/to/dataset-directory"
}
```
